import{S as E}from"./SubViewLayout-CENrvExW.js";import{t as $,a2 as x,z as k,a3 as O,bz as W,u as r,aU as B,r as l,cN as I,s as b,cO as H,b5 as h,b4 as F,cP as Z,cQ as X,cR as q,q as D,ct as R,cv as G,bv as U,cS as Q,x as K,y as P,cT as J,aj as ee,cU as te,A as ne,b7 as oe,cV as ae,I as N,H as t,aL as ie,al as se,ar as L,a4 as re,a5 as m,Q as z,cW as le,O as M,a7 as ce,as as ue,N as de}from"./index-CM2QD9e-.js";import{F as fe}from"./FriendApply-pBjKZTm9.js";import{G as me}from"./GroupApply-Cqb0G_vY.js";import{_ as he,b as be}from"./Tabs-1DLY5Q3c.js";import{S as ke}from"./Scrollbar-BH2Jkg_N.js";import{g as ve}from"./attribute-Cz32yFEB.js";import"./ButtonDropdown.vue_vue_type_script_setup_true_lang-BVX66N5L.js";import"./Dropdown-Bh7zZTID.js";import"./create-BOEuAWPS.js";import"./useInject-7veinSf8.js";import"./string-DvZm4MNo.js";import"./Input-DQKTV4RQ.js";import"./use-locale-DTwH8Qcq.js";import"./SendOne-DmuvVrB6.js";import"./Tooltip-nXjUsOav.js";import"./Empty-kVCNEqgM.js";const V=$({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const a=x(null),s=x(e.value),c=x(e.value),o=x("up"),n=x(!1),d=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${o.value}-scroll`:null),v=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${o.value}-scroll`:null);O(W(e,"value"),(i,u)=>{s.value=u,c.value=i,B(p)});function p(){const i=e.newOriginalNumber,u=e.oldOriginalNumber;u===void 0||i===void 0||(i>u?g("up"):u>i&&g("down"))}function g(i){o.value=i,n.value=!1,B(()=>{var u;(u=a.value)===null||u===void 0||u.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:i}=e;return r("span",{ref:a,class:`${i}-base-slot-machine-number`},s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--top`,v.value]},s.value):null,r("span",{class:[`${i}-base-slot-machine-current-number`,d.value]},r("span",{ref:"numberWrapper",class:[`${i}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${i}-base-slot-machine-current-number__inner--not-number`]},c.value)),s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--bottom`,v.value]},s.value):null)}}}),{cubicBezierEaseOut:_}=I;function ge({duration:e=".2s"}={}){return[l("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${_},
 max-width ${e} ${_},
 transform ${e} ${_}
