import{s as l,b3 as g,b5 as n,r,b4 as p,t as $,u as x,x as C,cP as N,cU as z,cC as P,ej as S,I as T,H as c,a4 as h,a5 as u,W as D,ad as L,U as R,P as E,a7 as W,Q as j,N as b}from"./index-CM2QD9e-.js";import{N as G}from"./Dropdown-Bh7zZTID.js";const t="0!important",_="-1px!important";function i(o){return n(`${o}-type`,[r("& +",[l("button",{},[n(`${o}-type`,[p("border",{borderLeftWidth:t}),p("state-border",{left:_})])])])])}function s(o){return n(`${o}-type`,[r("& +",[l("button",[n(`${o}-type`,[p("border",{borderTopWidth:t}),p("state-border",{top:_})])])])])}const I=l("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
