import{s as l,b5 as g,b7 as n,r,b6 as p,t as $,u as x,x as C,cQ as N,cV as z,cE as S,ek as T,I as D,H as c,a4 as h,a5 as u,W as E,ad as L,U as P,P as R,a7 as W,Q as G,N as b}from"./index-Bsk2BsFg.js";import{N as I}from"./Dropdown-1lK1L3pV.js";const t="0!important",_="-1px!important";function i(o){return n(`${o}-type`,[r("& +",[l("button",{},[n(`${o}-type`,[p("border",{borderLeftWidth:t}),p("state-border",{left:_})])])])])}function s(o){return n(`${o}-type`,[r("& +",[l("button",[n(`${o}-type`,[p("border",{borderTopWidth:t}),p("state-border",{top:_})])])])])}const V=l("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
