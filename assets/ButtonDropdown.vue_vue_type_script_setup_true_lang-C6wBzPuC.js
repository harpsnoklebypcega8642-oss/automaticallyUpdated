import{s as l,b6 as g,b8 as n,r,b7 as p,t as $,u as x,x as C,cR as N,cW as z,cF as R,el as S,I as T,H as c,a4 as h,a5 as u,W as D,ad as L,U as P,P as W,a7 as E,Q as G,N as b}from"./index-Ct9cQUdc.js";import{N as I}from"./Dropdown-nKEwravd.js";const t="0!important",_="-1px!important";function i(o){return n(`${o}-type`,[r("& +",[l("button",{},[n(`${o}-type`,[p("border",{borderLeftWidth:t}),p("state-border",{left:_})])])])])}function s(o){return n(`${o}-type`,[r("& +",[l("button",[n(`${o}-type`,[p("border",{borderTopWidth:t}),p("state-border",{top:_})])])])])}const j=l("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
