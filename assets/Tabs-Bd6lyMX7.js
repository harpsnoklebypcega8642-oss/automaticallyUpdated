import{z as X,w as d,r as L,ei as ye,ej as ut,ek as vt,el as ht,h as ee,em as gt,x as xt,_ as mt,A as Pe,E as yt,di as wt,R as St,a1 as Ct,dN as Rt,c as Z,dV as Tt,P as r,W as i,O as S,Y as T,c0 as zt,K as ne,c3 as we,V as oe,F as $t,T as _e,en as Pt,eo as Se,aa as _t,aF as ie,H as Wt,I as Et,J as j,ep as At,a4 as Lt,U as I,dk as J,ab as kt,dm as Bt,az as jt,da as It,L as Ht,ad as se,v as Ot,ae as Q}from"./index-BNlgNkbi.js";const Ft=ye(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[ye("&::-webkit-scrollbar",{width:0,height:0})]),Mt=X({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(c){!(c.currentTarget.offsetWidth<c.currentTarget.scrollWidth)||c.deltaY===0||(c.currentTarget.scrollLeft+=c.deltaY+c.deltaX,c.preventDefault())}const s=ut();return Ft.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:vt,ssr:s}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...c){var m;(m=e.value)===null||m===void 0||m.scrollTo(...c)}})},render(){return d("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Dt=/\s/;function Nt(e){for(var n=e.length;n--&&Dt.test(e.charAt(n)););return n}var Vt=/^\s+/;function Ut(e){return e&&e.slice(0,Nt(e)+1).replace(Vt,"")}var Ce=NaN,Xt=/^[-+]0x[0-9a-f]+$/i,Gt=/^0b[01]+$/i,Yt=/^0o[0-7]+$/i,Kt=parseInt;function Re(e){if(typeof e=="number")return e;if(ht(e))return Ce;if(ee(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=ee(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ut(e);var s=Gt.test(e);return s||Yt.test(e)?Kt(e.slice(2),s?2:8):Xt.test(e)?Ce:+e}var le=function(){return gt.Date.now()},qt="Expected a function",Jt=Math.max,Qt=Math.min;function Zt(e,n,s){var u,c,m,v,f,x,h=0,g=!1,W=!1,E=!0;if(typeof e!="function")throw new TypeError(qt);n=Re(n)||0,ee(s)&&(g=!!s.leading,W="maxWait"in s,m=W?Jt(Re(s.maxWait)||0,n):m,E="trailing"in s?!!s.trailing:E);function y(b){var R=u,F=c;return u=c=void 0,h=b,v=e.apply(F,R),v}function z(b){return h=b,f=setTimeout(_,n),g?y(b):v}function C(b){var R=b-x,F=b-h,G=n-R;return W?Qt(G,m-F):G}function P(b){var R=b-x,F=b-h;return x===void 0||R>=n||R<0||W&&F>=m}function _(){var b=le();if(P(b))return $(b);f=setTimeout(_,C(b))}function $(b){return f=void 0,E&&u?y(b):(u=c=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=x=c=f=void 0}function A(){return f===void 0?v:$(le())}function p(){var b=le(),R=P(b);if(u=arguments,c=this,x=b,R){if(f===void 0)return z(x);if(W)return clearTimeout(f),f=setTimeout(_,n),y(x)}return f===void 0&&(f=setTimeout(_,n)),v}return p.cancel=O,p.flush=A,p}var ea="Expected a function";function de(e,n,s){var u=!0,c=!0;if(typeof e!="function")throw new TypeError(ea);return ee(s)&&(u="leading"in s?!!s.leading:u,c="trailing"in s?!!s.trailing:c),Zt(e,n,{leading:u,maxWait:n,trailing:c})}const ta=X({name:"Add",render(){return d("svg",{width:"512",height:"512",viewBox:"0 0 512 512",fill:"none",xmlns:"http://www.w3.org/2000/svg"},d("path",{d:"M256 112V400M400 256H112",stroke:"currentColor","stroke-width":"32","stroke-linecap":"round","stroke-linejoin":"round"}))}}),fe=xt("n-tabs"),We={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},ia=X({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:We,slots:Object,setup(e){const n=Pe(fe,null);return n||mt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return d("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),aa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Tt(We,["displayDirective"])),be=X({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:aa,setup(e){const{mergedClsPrefixRef:n,valueRef:s,typeRef:u,closableRef:c,tabStyleRef:m,addTabStyleRef:v,tabClassRef:f,addTabClassRef:x,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:W,handleAdd:E,activateTab:y,handleClose:z}=Pe(fe);return{trigger:W,mergedClosable:Z(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?c.value:C}),style:m,addStyle:v,tabClass:f,addTabClass:x,clsPrefix:n,value:s,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&z(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:C}=e,P=++h.id;if(C!==s.value){const{value:_}=g;_?Promise.resolve(_(e.name,s.value)).then($=>{$&&h.id===P&&y(C)}):y(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:s,disabled:u,label:c,tab:m,value:v,mergedClosable:f,trigger:x,$slots:{default:h}}=this,g=c??m;return d("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?d("div",{class:`${n}-tabs-tab-pad`}):null,d("div",Object.assign({key:s,"data-name":s,"data-disabled":u?!0:void 0},yt({class:[`${n}-tabs-tab`,v===s&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),d("span",{class:`${n}-tabs-tab__label`},e?d(St,null,d("div",{class:`${n}-tabs-tab__height-placeholder`}," "),d(Ct,{clsPrefix:n},{default:()=>d(ta,null)})):h?h():typeof g=="object"?g:wt(g??s)),f&&this.type==="card"?d(Rt,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ra=r("tabs",`
