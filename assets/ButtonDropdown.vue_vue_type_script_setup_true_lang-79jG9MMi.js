import{P as l,c0 as g,W as n,O as r,Y as p,z as $,w as x,F as C,d9 as z,dd as N,I as S,f9 as T,aj as D,ak as c,aG as h,aH as u,ay as L,a2 as P,aw as R,as as E,aJ as G,at as W,aq as b}from"./index-CP-huyAt.js";import{N as j}from"./Dropdown-Djx1pCTK.js";const t="0!important",y="-1px!important";function i(o){return n(`${o}-type`,[r("& +",[l("button",{},[n(`${o}-type`,[p("border",{borderLeftWidth:t}),p("state-border",{left:y})])])])])}function s(o){return n(`${o}-type`,[r("& +",[l("button",[n(`${o}-type`,[p("border",{borderTopWidth:t}),p("state-border",{top:y})])])])])}const I=l("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
