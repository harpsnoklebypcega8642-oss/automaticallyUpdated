...
`,[x("checked",[s("dot",`
 ...
 cursor: not-allowed;
 `)])]),fe={name:String,value:{type:[String,Number,Boolean],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,default:void 0}},J=de("n-radio-group");function ge(o){const e=se(J,null),t=M(o,{mergedSize(n){const{size:u}=o;if(u!==void 0)return u;if(e){const{mergedSizeRef:{value:v}}=e;if(v!==void 0)return v}return n?n.mergedSize.value:"medium"},mergedDisabled(n){return!!(o.disabled||e!=null&&e.disabledRef.value||n!=null&&n.disabled.value)}}),{mergedSizeRef:a,mergedDisabledRef:r}=t,l=$(null),d=$(null),c=$(o.defaultChecked),i=E(o,"checked"),f=L(i,c),g=G(()=>e?e.valueRef.value===o.value:f.value),C=G(()=>{const{name:n}=o;if(n!==void 0)return n;if(e)return e.nameRef.value}),h=$(!1);function w(){if(e){const{doUpdateValue:n}=e,{value:u}=o;F(n,u)}else{const{onUpdateChecked:n,"onUpdate:checked":u}=o,{nTriggerFormInput:v,nTriggerFormChange:b}=t;n&&F(n,!0),u&&F(u,!0),v(),b(),c.value=!0}}function m(){r.value||g.value||w()}function R(){m(),l.value&&(l.value.checked=g.value)}function z(){h.value=!1}function k(){h.value=!0}return{mergedClsPrefix:e?e.mergedClsPrefixRef:j(o).mergedClsPrefixRef,inputRef:l,labelRef:d,mergedName:C,mergedDisabled:r,renderSafeChecked:g,focus:h,mergedSize:a,handleRadioInputChange:R,handleRadioInputBlur:z,handleRadioInputFocus:k}}const pe=Object.assign(Object.assign({},V.props),fe),Se=N({name:"Radio",props:pe,setup(o){const e=ge(o),t=V("Radio","-radio",ve,Y,o,e.mergedClsPrefix),a=I(()=>{const{mergedSize:{value:f}}=e,{common:{cubicBezierEaseInOut:g},self:{boxShadow:C,boxShadowActive:h,boxShadowDisabled:w,boxShadowFocus:m,boxShadowHover:R,color:z,colorDisabled:k,colorActive:n,textColor:u,textColorDisabled:v,dotColorActive:b,dotColorDisabled:p,labelPadding:_,labelLineHeight:T,labelFontWeight:A,[D("fontSize",f)]:H,[D("radioSize",f)]:U}}=t.value;return{"--n-bezier":g,"--n-label-line-height":T,"--n-label-font-weight":A,"--n-box-shadow":C,"--n-box-shadow-active":h,"--n-box-shadow-disabled":w,"--n-box-shadow-focus":m,"--n-box-shadow-hover":R,"--n-color":z,"--n-color-active":n,"--n-color-disabled":k,"--n-dot-color-active":b,"--n-dot-color-disabled":p,"--n-font-size":H,"--n-radio-size":U,"--n-text-color":u,"--n-text-color-disabled":v,"--n-label-padding":_}}),{inlineThemeDisabled:r,mergedClsPrefixRef:l,mergedRtlRef:d}=j(o),c=K("Radio",d,l),i=r?W("radio",I(()=>e.mergedSize.value[0]),a,o):void 0;return Object.assign(e,{rtlEnabled:c,cssVars:r?void 0:a,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender})},render(){const{$slots:o,mergedClsPrefix:e,onRender:t,label:a}=this;return t==null||t(),y("label",{class:[`${e}-radio`,this.themeClass,this.rtlEnabled&&`${e}-radio--rtl`,this.mergedDisabled&&`${e}-radio--disabled`,this.renderSafeChecked&&`${e}-radio--checked`,this.focus&&`${e}-radio--focus`],style:this.cssVars},y("input",{ref:"inputRef",type:"radio",class:`${e}-radio-input`,value:this.value,name:this.mergedName,checked:this.renderSafeChecked,disabled:this.mergedDisabled,onChange:this.handleRadioInputChange,onFocus:this.handleRadioInputFocus,onBlur:this.handleRadioInputBlur}),y("div",{class:`${e}-radio__dot-wrapper`}," ",y("div",{class:[`${e}-radio__dot`,this.renderSafeChecked&&`${e}-radio__dot--checked`]})),le(o.default,r=>!r&&!a?null:y("div",{ref:"labelRef",class:`${e}-radio__label`},r||a)))}}),me=B("radio-group",`
 display: inline-block;
 font-size: var(--n-font-size);
`,[s("splitor",`
 display: inline-block;
