import{S as E}from"./SubViewLayout-jTwMOo00.js";import{z as $,r as x,c as k,aF as P,J as W,w as r,ad as B,O as l,d7 as I,P as b,d8 as H,W as h,Y as F,d9 as Z,da as G,$ as X,N as q,cT as M,cW as D,a6 as U,db as J,F as K,T as O,dc as Q,H as ee,dd as te,U as ne,ab as ae,de as oe,aj as N,ak as t,bk as ie,aV as se,a$ as L,aG as re,aH as m,at as z,df as le,ar as R,aJ as ce,b0 as ue,aq as de}from"./index-BNlgNkbi.js";import{F as fe}from"./FriendApply-Cv_tsIOo.js";import{G as me}from"./GroupApply-CAWSE0C-.js";import{_ as he,b as be}from"./Tabs-Bd6lyMX7.js";import{S as ke}from"./Scrollbar-D-hA6qiy.js";import{g as ve}from"./attribute-Cz32yFEB.js";import"./ButtonDropdown.vue_vue_type_script_setup_true_lang-Ch5fOvAX.js";import"./Dropdown-CdGSfteg.js";import"./create-BOEuAWPS.js";import"./useInject-Adcztcg6.js";import"./string-DvZm4MNo.js";import"./Input-CwkONfTO.js";import"./use-locale-C9Iw-Z_K.js";import"./SendOne-DWBmd-rZ.js";import"./Tooltip-BoqLxAsb.js";import"./Empty-DijpdffX.js";const V=$({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const o=x(null),s=x(e.value),c=x(e.value),a=x("up"),n=x(!1),d=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${a.value}-scroll`:null),v=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${a.value}-scroll`:null);P(W(e,"value"),(i,u)=>{s.value=u,c.value=i,B(p)});function p(){const i=e.newOriginalNumber,u=e.oldOriginalNumber;u===void 0||i===void 0||(i>u?g("up"):u>i&&g("down"))}function g(i){a.value=i,n.value=!1,B(()=>{var u;(u=o.value)===null||u===void 0||u.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:i}=e;return r("span",{ref:o,class:`${i}-base-slot-machine-number`},s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--top`,v.value]},s.value):null,r("span",{class:[`${i}-base-slot-machine-current-number`,d.value]},r("span",{ref:"numberWrapper",class:[`${i}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${i}-base-slot-machine-current-number__inner--not-number`]},c.value)),s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--bottom`,v.value]},s.value):null)}}}),{cubicBezierEaseOut:_}=I;function ge({duration:e=".2s"}={}){return[l("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${_},
 max-width ${e} ${_},
 transform ${e} ${_}
