import{y as p,bx as q,q as A,s as L,b8 as M,b7 as a,r as v,t as H,u as c,by as D,bz as G,bA as K,bB as Z,x as X,a2 as z,bC as Y,bD as J,z as S,bE as x,bF as Q,ba as ee,aj as oe,bG as te,aV as ne,bH as re,bI as P,I as C,H as n,al as ie}from"./index-Ct9cQUdc.js";import{N as se}from"./Dropdown-nKEwravd.js";Object.assign(Object.assign({},p.props),{left:[Number,String],right:[Number,String],top:[Number,String],bottom:[Number,String],shape:{type:String,default:"circle"},position:{type:String,default:"fixed"}});const ae=q("n-float-button-group");function le(e){const{popoverColor:o,textColor2:s,buttonColor2Hover:l,buttonColor2Pressed:f,primaryColor:i,primaryColorHover:u,primaryColorPressed:b,borderRadius:t}=e;return{color:o,colorHover:l,colorPressed:f,colorPrimary:i,colorPrimaryHover:u,colorPrimaryPressed:b,textColor:s,boxShadow:"0 2px 8px 0px rgba(0, 0, 0, .16)",boxShadowHover:"0 2px 12px 0px rgba(0, 0, 0, .24)",boxShadowPressed:"0 2px 12px 0px rgba(0, 0, 0, .24)",textColorPrimary:"#fff",borderRadiusSquare:t}}const de={common:A,self:le},ce=L("float-button",`
 user-select: none;
 cursor: pointer;
...
`,[M("circle-shape",`
 ...
 text-align: center;
 line-height: 14px;
 `)]),v("&:hover","box-shadow: var(--n-box-shadow-hover);",[v(">",[a("fill",`
 background-color: var(--n-color-hover);
 `)])]),v("&:active","box-shadow: var(--n-box-shadow-pressed);",[v(">",[a("fill",`
 background-color: var(--n-color-pressed);
 `)])]),M("show-menu",[v(">",[a("menu",`
 pointer-events: all;
 bottom: 100%;
 opacity: 1;
 `),a("close",`
