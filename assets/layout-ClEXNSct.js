import{S as T}from"./SubViewLayout-uv2Gc8ps.js";import{t as $,a2 as x,z as k,a3 as O,bv as W,u as r,b$ as B,r as l,cJ as I,s as b,cK as H,b1 as h,b0 as F,cL as Z,cM as q,cN as X,q as D,cq as M,cs as G,br as K,cO as Q,x as U,y as P,cP as J,aj as ee,cQ as te,A as ne,b3 as oe,cR as ae,I as N,H as t,aK as ie,al as se,ar as L,a4 as re,a5 as m,Q as z,cS as le,O as R,a7 as ce,as as ue,N as de}from"./index-BO9T8dKv.js";import{F as fe}from"./FriendApply-B6-dWF25.js";import{G as me}from"./GroupApply-Bw5e12N8.js";import{_ as he,b as be}from"./Tabs-l_Rvbyzm.js";import{S as ke}from"./Scrollbar-Dc8PKZLa.js";import{g as ve}from"./attribute-Cz32yFEB.js";import"./ButtonDropdown.vue_vue_type_script_setup_true_lang-DPkocNEB.js";import"./Dropdown-CaT3ns9T.js";import"./create-BOEuAWPS.js";import"./useInject-DkPEEzDc.js";import"./string-BCM9Zf9k.js";import"./Input-CQGSZsp6.js";import"./use-locale-CWF10lZO.js";import"./SendOne-Cp6bx0ot.js";import"./Tooltip-De9fHY5R.js";import"./Empty-CtmszbtV.js";const V=$({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const a=x(null),s=x(e.value),c=x(e.value),o=x("up"),n=x(!1),d=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${o.value}-scroll`:null),v=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${o.value}-scroll`:null);O(W(e,"value"),(i,u)=>{s.value=u,c.value=i,B(p)});function p(){const i=e.newOriginalNumber,u=e.oldOriginalNumber;u===void 0||i===void 0||(i>u?g("up"):u>i&&g("down"))}function g(i){o.value=i,n.value=!1,B(()=>{var u;(u=a.value)===null||u===void 0||u.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:i}=e;return r("span",{ref:a,class:`${i}-base-slot-machine-number`},s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--top`,v.value]},s.value):null,r("span",{class:[`${i}-base-slot-machine-current-number`,d.value]},r("span",{ref:"numberWrapper",class:[`${i}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${i}-base-slot-machine-current-number__inner--not-number`]},c.value)),s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--bottom`,v.value]},s.value):null)}}}),{cubicBezierEaseOut:_}=I;function ge({duration:e=".2s"}={}){return[l("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${_},
 max-width ${e} ${_},
 transform ${e} ${_}
