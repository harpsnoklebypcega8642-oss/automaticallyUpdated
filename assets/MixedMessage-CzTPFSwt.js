import{t as u}from"./emojis-Sb65fHZp.js";import{t as f}from"./string-DvZm4MNo.js";import{h as g}from"./file-C602ILNy.js";import{t as x,M as o,N as r,O as p,U as t,F as m,R as y,W as M,Q as a,Y as k,H as w,_ as N}from"./index-D-GEfZT9.js";import{_ as v}from"./Image-im4GuSCC.js";import"./Tooltip-J8Mjo4KE.js";import"./use-locale-DrbPIHw8.js";const L={class:"im-message-mixed"},V=["innerHTML"],_=x({__name:"MixedMessage",props:{items:{}},setup(B){const d=(i,e=200)=>{const n=g(i);if(n.width==0||n.height==0)return{};if(n.width<e)return{width:`${n.width}px`,height:`${n.height}px`};let s=n.height/(n.width/e);return{width:e+"px",height:s+"px"}};return(i,e)=>{const n=v;return r(),o("div",L,[p("pre",null,[e[8]||(e[8]=t("      ")),(r(!0),o(m,null,y(i.items,(s,l)=>(r(),o("span",{class:"line",key:l},[e[6]||(e[6]=t(`
