import{q as ae,eQ as ie,eR as O,s as B,b7 as x,b6 as s,b5 as P,r as S,bw as de,bE as se,dL as M,a2 as $,bB as U,bC as G,d1 as L,x as j,bH as F,t as N,u as y,bA as le,y as V,z as D,A as I,cV as K,b9 as W,ee as ce,cE as ue}from"./index-Bsk2BsFg.js";import{g as be}from"./Space-D4uJVB-5.js";function he(o){const{borderColor:e,primaryColor:t,baseColor:a,textColorDisabled:r,inputColorDisabled:l,textColor2:d,opacityDisabled:c,borderRadius:i,fontSizeSmall:f,fontSizeMedium:g,fontSizeLarge:C,heightSmall:h,heightMedium:w,heightLarge:m,lineHeight:R}=o;return Object.assign(Object.assign({},ie),{labelLineHeight:R,buttonHeightSmall:h,buttonHeightMedium:w,buttonHeightLarge:m,fontSizeSmall:f,fontSizeMedium:g,fontSizeLarge:C,boxShadow:`inset 0 0 0 1px ${e}`,boxShadowActive:`inset 0 0 0 1px ${t}`,boxShadowFocus:`inset 0 0 0 1px ${t}, 0 0 0 2px ${O(t,{alpha:.2})}`,boxShadowHover:`inset 0 0 0 1px ${t}`,boxShadowDisabled:`inset 0 0 0 1px ${e}`,color:a,colorDisabled:l,colorActive:"#0000",textColor:d,textColorDisabled:r,dotColorActive:t,dotColorDisabled:e,buttonBorderColor:e,buttonBorderColorActive:t,buttonBorderColorHover:e,buttonColor:a,buttonColorActive:a,buttonTextColor:d,buttonTextColorActive:t,buttonTextColorHover:t,opacityDisabled:c,buttonBoxShadowFocus:`inset 0 0 0 1px ${t}, 0 0 0 2px ${O(t,{alpha:.3})}`,buttonBoxShadowHover:"inset 0 0 0 1px #0000",buttonBoxShadow:"inset 0 0 0 1px #0000",buttonBorderRadius:i})}const q={common:ae,self:he},ve=B("radio",`
...
`,[x("checked",[s("dot",`
 ...
 cursor: not-allowed;
 `)])]),fe={name:String,value:{type:[String,Number,Boolean],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,default:void 0}},Q=de("n-radio-group");function ge(o){const e=se(Q,null),t=M(o,{mergedSize(n){const{size:u}=o;if(u!==void 0)return u;if(e){const{mergedSizeRef:{value:v}}=e;if(v!==void 0)return v}return n?n.mergedSize.value:"medium"},mergedDisabled(n){return!!(o.disabled||e!=null&&e.disabledRef.value||n!=null&&n.disabled.value)}}),{mergedSizeRef:a,mergedDisabledRef:r}=t,l=$(null),d=$(null),c=$(o.defaultChecked),i=U(o,"checked"),f=G(i,c),g=L(()=>e?e.valueRef.value===o.value:f.value),C=L(()=>{const{name:n}=o;if(n!==void 0)return n;if(e)return e.nameRef.value}),h=$(!1);function w(){if(e){const{doUpdateValue:n}=e,{value:u}=o;F(n,u)}else{const{onUpdateChecked:n,"onUpdate:checked":u}=o,{nTriggerFormInput:v,nTriggerFormChange:b}=t;n&&F(n,!0),u&&F(u,!0),v(),b(),c.value=!0}}function m(){r.value||g.value||w()}function R(){m(),l.value&&(l.value.checked=g.value)}function z(){h.value=!1}function k(){h.value=!0}return{mergedClsPrefix:e?e.mergedClsPrefixRef:j(o).mergedClsPrefixRef,inputRef:l,labelRef:d,mergedName:C,mergedDisabled:r,renderSafeChecked:g,focus:h,mergedSize:a,handleRadioInputChange:R,handleRadioInputBlur:z,handleRadioInputFocus:k}}const pe=Object.assign(Object.assign({},V.props),fe),Se=N({name:"Radio",props:pe,setup(o){const e=ge(o),t=V("Radio","-radio",ve,q,o,e.mergedClsPrefix),a=D(()=>{const{mergedSize:{value:f}}=e,{common:{cubicBezierEaseInOut:g},self:{boxShadow:C,boxShadowActive:h,boxShadowDisabled:w,boxShadowFocus:m,boxShadowHover:R,color:z,colorDisabled:k,colorActive:n,textColor:u,textColorDisabled:v,dotColorActive:b,dotColorDisabled:p,labelPadding:_,labelLineHeight:A,labelFontWeight:H,[I("fontSize",f)]:T,[I("radioSize",f)]:E}}=t.value;return{"--n-bezier":g,"--n-label-line-height":A,"--n-label-font-weight":H,"--n-box-shadow":C,"--n-box-shadow-active":h,"--n-box-shadow-disabled":w,"--n-box-shadow-focus":m,"--n-box-shadow-hover":R,"--n-color":z,"--n-color-active":n,"--n-color-disabled":k,"--n-dot-color-active":b,"--n-dot-color-disabled":p,"--n-font-size":T,"--n-radio-size":E,"--n-text-color":u,"--n-text-color-disabled":v,"--n-label-padding":_}}),{inlineThemeDisabled:r,mergedClsPrefixRef:l,mergedRtlRef:d}=j(o),c=K("Radio",d,l),i=r?W("radio",D(()=>e.mergedSize.value[0]),a,o):void 0;return Object.assign(e,{rtlEnabled:c,cssVars:r?void 0:a,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender})},render(){const{$slots:o,mergedClsPrefix:e,onRender:t,label:a}=this;return t==null||t(),y("label",{class:[`${e}-radio`,this.themeClass,this.rtlEnabled&&`${e}-radio--rtl`,this.mergedDisabled&&`${e}-radio--disabled`,this.renderSafeChecked&&`${e}-radio--checked`,this.focus&&`${e}-radio--focus`],style:this.cssVars},y("input",{ref:"inputRef",type:"radio",class:`${e}-radio-input`,value:this.value,name:this.mergedName,checked:this.renderSafeChecked,disabled:this.mergedDisabled,onChange:this.handleRadioInputChange,onFocus:this.handleRadioInputFocus,onBlur:this.handleRadioInputBlur}),y("div",{class:`${e}-radio__dot-wrapper`}," ",y("div",{class:[`${e}-radio__dot`,this.renderSafeChecked&&`${e}-radio__dot--checked`]})),le(o.default,r=>!r&&!a?null:y("div",{ref:"labelRef",class:`${e}-radio__label`},r||a)))}}),me=B("radio-group",`
 display: inline-block;
 font-size: var(--n-font-size);
`,[s("splitor",`
 display: inline-block;
