import{S as E}from"./SubViewLayout-Btkcg0vY.js";import{t as $,a2 as x,z as k,a3 as P,bC as W,u as r,aU as B,r as l,cP as I,s as b,cQ as H,b8 as h,b7 as F,cR as X,cS as Z,cT as q,q as D,cw as R,cy as G,by as U,cU as Q,x as K,y as O,cV as J,aj as ee,cW as te,A as ne,ba as oe,cX as ae,I as S,H as t,aL as ie,al as se,ar as L,a4 as re,a5 as m,Q as z,cY as le,O as M,a7 as ce,as as ue,N as de}from"./index-Ct9cQUdc.js";import{F as fe}from"./FriendApply-BlRuS6Nu.js";import{G as me}from"./GroupApply-BNr-Q0rc.js";import{_ as he,b as be}from"./Tabs-CAZFQqxa.js";import{S as ke}from"./Scrollbar-DaEpbMjy.js";import{g as ve}from"./attribute-Cz32yFEB.js";import"./ButtonDropdown.vue_vue_type_script_setup_true_lang-C6wBzPuC.js";import"./Dropdown-nKEwravd.js";import"./create-BOEuAWPS.js";import"./useInject-C2SBrW6P.js";import"./string-DvZm4MNo.js";import"./Input-Bx0Qpk2X.js";import"./use-locale-D4tvGKN8.js";import"./SendOne-hIOGt4-u.js";import"./Tooltip-BOW5CeXo.js";import"./Empty--JomUMPb.js";const V=$({name:"SlotMachineNumber",props:{clsPrefix:{type:String,required:!0},value:{type:[Number,String],required:!0},oldOriginalNumber:{type:Number,default:void 0},newOriginalNumber:{type:Number,default:void 0}},setup(e){const a=x(null),s=x(e.value),c=x(e.value),o=x("up"),n=x(!1),d=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-current-number--${o.value}-scroll`:null),v=k(()=>n.value?`${e.clsPrefix}-base-slot-machine-old-number--${o.value}-scroll`:null);P(W(e,"value"),(i,u)=>{s.value=u,c.value=i,B(p)});function p(){const i=e.newOriginalNumber,u=e.oldOriginalNumber;u===void 0||i===void 0||(i>u?g("up"):u>i&&g("down"))}function g(i){o.value=i,n.value=!1,B(()=>{var u;(u=a.value)===null||u===void 0||u.offsetWidth,n.value=!0})}return()=>{const{clsPrefix:i}=e;return r("span",{ref:a,class:`${i}-base-slot-machine-number`},s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--top`,v.value]},s.value):null,r("span",{class:[`${i}-base-slot-machine-current-number`,d.value]},r("span",{ref:"numberWrapper",class:[`${i}-base-slot-machine-current-number__inner`,typeof e.value!="number"&&`${i}-base-slot-machine-current-number__inner--not-number`]},c.value)),s.value!==null?r("span",{class:[`${i}-base-slot-machine-old-number ${i}-base-slot-machine-old-number--bottom`,v.value]},s.value):null)}}}),{cubicBezierEaseOut:_}=I;function ge({duration:e=".2s"}={}){return[l("&.fade-up-width-expand-transition-leave-active",{transition:`
 opacity ${e} ${_},
 max-width ${e} ${_},
 transform ${e} ${_}
